...
export const vaFacilityLocations: Record<string, VAFacility[]> = {
  florida: [
    ...
    { name: 'Gainesville VA Medical Center', lat: 29.64, lon: -82.352 },
    { name: 'Lake City VA Medical Center', lat: 30.19, lon: -82.637 },
  ...
  texas: [
    ...
    { name: 'Dallas VA Medical Center', lat: 32.814, lon: -96.82 },
    ...
    { name: 'Kerrville VA Medical Center', lat: 30.047, lon: -99.14 },
    ...
    { name: 'Fort Worth VA Outpatient Clinic', lat: 32.745, lon: -97.33 },
  ],
  virginia: [
    { name: 'Hampton VA Medical Center', lat: 37.024, lon: -76.34 },
    { name: 'Richmond VA Medical Center (McGuire)', lat: 37.48, lon: -77.439 },
  ...
  tennessee: [
    ...
    { name: 'Mountain Home VA Medical Center (James H. Quillen)', lat: 36.31, lon: -82.374 },
  ...
  alaska: [
    { name: 'Anchorage VA Medical Center', lat: 61.218, lon: -149.9 },
    { name: 'Fairbanks VA Outpatient Clinic', lat: 64.838, lon: -147.716 },
  ],
  wyoming: [{ name: 'Cheyenne VA Medical Center', lat: 41.137, lon: -104.82 }],
  'south-dakota': [
  ...
  'north-carolina': [
    ...
    { name: 'Salisbury VA Medical Center (W.G. Hefner)', lat: 35.67, lon: -80.474 },
  ...
  georgia: [
    ...
    { name: 'Dublin VA Medical Center (Carl Vinson)', lat: 32.54, lon: -82.903 },
    { name: 'Decatur VA Medical Center', lat: 33.772, lon: -84.296 },
    { name: 'Savannah VA Outpatient Clinic', lat: 32.083, lon: -81.1 },
    { name: 'Columbus VA Outpatient Clinic', lat: 32.461, lon: -84.988 },
  ],
  california: [
    { name: 'Fresno VA Medical Center', lat: 36.787, lon: -119.79 },
  ...
  arizona: [
    ...
    { name: 'Tucson VA Medical Center (Southern Arizona)', lat: 32.235, lon: -110.96 },
    { name: 'Flagstaff VA Outpatient Clinic', lat: 35.198, lon: -111.651 },
    { name: 'Sun City VA Outpatient Clinic', lat: 33.6, lon: -112.273 },
  ],
  colorado: [
  ...
  oregon: [
    ...
    {
      name: 'White City VA Medical Center (Southern Oregon Rehabilitation)',
      lat: 42.422,
      lon: -122.847,
    },
  ...
  idaho: [
    { name: 'Boise VA Medical Center', lat: 43.6, lon: -116.226 },
  ...
  montana: [
    ...
    { name: 'Miles City VA Outpatient Clinic', lat: 46.408, lon: -105.84 },
  ],
  utah: [
  ...
  iowa: [
    { name: 'Des Moines VA Medical Center', lat: 41.6, lon: -93.628 },
  ...
  michigan: [
    ...
    { name: 'Iron Mountain VA Medical Center (Oscar G. Johnson)', lat: 45.82, lon: -88.067 },
  ...
  illinois: [
    ...
    { name: 'Danville VA Medical Center', lat: 40.13, lon: -87.601 },
    { name: 'Hines VA Medical Center (Edward Hines Jr.)', lat: 41.852, lon: -87.85 },
    { name: 'Marion VA Medical Center', lat: 37.731, lon: -88.933 },
    { name: 'North Chicago VA Medical Center (Captain James A. Lovell)', lat: 42.3, lon: -87.886 },
  ...
  ohio: [
    ...
    { name: 'Columbus VA Medical Center (Chalmers P. Wylie)', lat: 40.0, lon: -82.993 },
    { name: 'Dayton VA Medical Center', lat: 39.765, lon: -84.199 },
    { name: 'Toledo VA Outpatient Clinic', lat: 41.66, lon: -83.558 },
  ],
  pennsylvania: [
    { name: 'Altoona VA Medical Center (James E. Van Zandt)', lat: 40.496, lon: -78.4 },
    { name: 'Butler VA Medical Center', lat: 40.86, lon: -79.895 },
    { name: 'Coatesville VA Medical Center', lat: 39.98, lon: -75.823 },
    { name: 'Erie VA Medical Center', lat: 42.13, lon: -80.08 },
    { name: 'Lebanon VA Medical Center', lat: 40.333, lon: -76.411 },
    {
      name: 'Philadelphia VA Medical Center (Corporal Michael J. Crescenz)',
      lat: 39.944,
      lon: -75.181,
    },
  ...
  'new-york': [
    ...
    { name: 'Montrose VA Medical Center', lat: 41.246, lon: -73.93 },
  ...
  'new-jersey': [
    { name: 'East Orange VA Medical Center', lat: 40.764, lon: -74.21 },
  ...
  delaware: [{ name: 'Wilmington VA Medical Center', lat: 39.74, lon: -75.545 }],
  maryland: [
    ...
    { name: 'Fort Howard VA Outpatient Clinic', lat: 39.2, lon: -76.437 },
  ],
  'west-virginia': [
    { name: 'Beckley VA Medical Center', lat: 37.778, lon: -81.188 },
    { name: 'Clarksburg VA Medical Center (Louis A. Johnson)', lat: 39.28, lon: -80.345 },
    { name: 'Huntington VA Medical Center', lat: 38.399, lon: -82.435 },
  ],
  kentucky: [
    { name: 'Lexington VA Medical Center (Leestown)', lat: 38.067, lon: -84.53 },
  ...
  maine: [
    { name: 'Togus VA Medical Center', lat: 44.324, lon: -69.72 },
    { name: 'Portland VA Outpatient Clinic', lat: 43.661, lon: -70.255 },
  ],
  vermont: [{ name: 'White River Junction VA Medical Center', lat: 43.647, lon: -72.319 }],
  massachusetts: [
