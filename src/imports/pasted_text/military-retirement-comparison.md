Create a modern, clean, highly interactive web application UI for a tool called:

“Military Retirement State Comparison Tool”
...
- Card-based UI with data-rich views
- Mobile-first, but strong desktop dashboard experience
...
- 3 input fields:
  - Retirement income (slider + input)
  - Disability rating (optional)
  - Preferred region (dropdown or map)
- CTA: “Compare States”
...
- Toggle between:
  - Table view
  - Card view
  - Map view (heatmap of best states)
...
- Breakdown sections:
  ...
  - VA facilities nearby
  - Cost of living breakdown
- “Why this state is good/bad for you” AI-style summary
- Pros / Cons bullets
...
- Full multi-page layout:
  ...
  - State detail page
  - Mobile views
- Component system (buttons, filters, cards)